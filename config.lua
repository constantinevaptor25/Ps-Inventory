...
Config.MaxInventoryWeight = 90000 -- Max weight a player can carry (default 250kg, written in grams)
...
Config.ItemDropObject = `prop_cs_cardbox_01` -- if Config.UseItemDrop is true, this will be the prop that spawns for the item
...
Config.DropItems = {
    ...
    -- Pistol Attachments
    clip_attachments = `w_pi_sns_pistol_mag1`,
    grip_attachment = `w_at_ar_afgrip`,
    flashlight_attachment = `	prop_flash_unit`,
    ...
    suppressor_attachment = `w_at_ar_supp`,
